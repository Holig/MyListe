...
class CategoriesPage extends ConsumerWidget {
      ...
      body: categoriesAsync.when(
        ...
        data: (categories) {
          ...
          return ReorderableGridView.count(
            ...
            children: categories.map((categorie) => _buildCategoryCard(context, ref, categorie)).toList(),
            onReorder: (oldIndex, newIndex) => _reorderCategories(context, ref, categories, oldIndex, newIndex),
          );
        },
      ),
    );
  ...
  Widget _buildCategoryCard(BuildContext context, WidgetRef ref, Categorie categorie) {
    return Card(
      key: ValueKey(categorie.id),
      child: InkWell(
        onTap: () => _showEditCategoryDialog(context, ref, categorie),
        child: Padding(
          padding: const EdgeInsets.all(16),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
